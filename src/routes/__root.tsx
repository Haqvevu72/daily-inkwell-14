...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "A daily essay, read at your own pace. Light, dark, and sepia reading modes.",
      },
      { property: "og:title", content: "Daily Reading" },
      {
        property: "og:description",
        content: "A daily essay, read at your own pace.",
      },
